...
from model.vector_quantize_pytorch import VectorQuantize
...
class ResidualVQ(nn.Module):
    ...
    def __init__(
        ...
        self.layers = nn.ModuleList(
            [VectorQuantize(dim=codebook_dim, codebook_dim=codebook_dim, accept_image_fmap=accept_image_fmap, **kwargs)
    ...
    def forward(
        ...
        if should_quantize_dropout:
            rand = random.Random(rand_quantize_dropout_fixed_seed) if exists(
                rand_quantize_dropout_fixed_seed) else random
